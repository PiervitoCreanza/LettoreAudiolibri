...
// Ask for the book data
let finished = false
ipcRenderer.on('read-this', function(event, data, bookPath) {
...
/*
var a = true
ipcRenderer.on('closing-you', function() {
  let a = true
  if (a) {
      ...
      _createClass(GreenAudioPlayer, [{
        ...
        value: function initEvents() {
          ...
          this.player.addEventListener('ended', function () {
            ...
            if (!finished) {
                finished = true;
                ipcRenderer.send('reading-finished');
            }
          });
